# Podcast Hackathon 2022

## Code Conventions:

### Database tables :

All table names will be singular e.g., **country** not ~~countries~~
...
```
cd existing_repo
git remote add origin https://gl.xanda.net:9090/git/beis-aar-poc-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gl.xanda.net:9090/git/podcast/-/settings/integrations)
